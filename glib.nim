...
when not defined(windows): 
  ...
  proc g_file_get_contents*(filename: cstring; contents: var cstring; 
...
proc g_list_previous*(list: GList): GList {.inline.} = 
  if list != nil: list.prev else: nil

proc g_list_next*(list: GList): GList {.inline.} = 
...
proc keys_as_array*(hash_table: GHashTable; 
                                     length: ptr guint): ptr gpointer {.
    importc: "g_hash_table_get_keys_as_array", libglib.}
proc init*(iter: var GHashTableIterObj; 
                             hash_table: GHashTable) {.
    importc: "g_hash_table_iter_init", libglib.}
proc next*(iter: var GHashTableIterObj; key: ptr gpointer; 
                             value: ptr gpointer): gboolean {.
    importc: "g_hash_table_iter_next", libglib.}
proc get_hash_table*(iter: var GHashTableIterObj): GHashTable {.
    importc: "g_hash_table_iter_get_hash_table", libglib.}
proc hash_table*(iter: var GHashTableIterObj): GHashTable {.
    importc: "g_hash_table_iter_get_hash_table", libglib.}
proc remove*(iter: var GHashTableIterObj) {.
    importc: "g_hash_table_iter_remove", libglib.}
proc replace*(iter: var GHashTableIterObj; value: gpointer) {.
    importc: "g_hash_table_iter_replace", libglib.}
proc steal*(iter: var GHashTableIterObj) {.
...
proc g_random_boolean*(): gboolean {.inline.} =
